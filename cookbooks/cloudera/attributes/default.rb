...
default['hadoop']['core_site']['fs.default.name'] = "hdfs://10.1.4.69:54310"

default['hadoop']['hdfs_site'] = {
 'dfs.name.dir' => '/mnt/data/1/dfs/nn,/mnt/nfsmount/dfs/nn',
 'dfs.data.dir' => '/mnt/data/1/dfs/dn,/mnt/data/2/dfs/dn,/mnt/data/3/dfs/dn'
}
default['hadoop']['hdfs_site']['fs.default.name'] = "hdfs://10.1.4.69:54310"
default['hadoop']['hdfs_site']['dfs.secondary.http.address'] = "hdfs://10.1.4.71:50090"

default['hadoop']['mapred_site'] = {
  'mapred.fairscheduler.allocation.file' => "#{node['hadoop']['conf_dir']}/fair-scheduler.xml",
  'mapred.local.dir' => '/mnt/data/1/mapred/local,/mnt/data/2/mapred/local,/mnt/data/3/mapred/local'
}
